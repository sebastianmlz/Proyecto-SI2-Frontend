...
export const routes: Routes = [
  ...
  { path: 'productos/:id', loadComponent: () => import('./Paginas/products/products-details/products-details.component').then(m => m.ProductsDetailsComponent), canActivate: [authGuard] },
